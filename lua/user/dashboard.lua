...
local buttons = {
  ...
  val = {
    ...
    button("c", " " .. kind.icons.settings .. " Config", ":e ~/.config/nvim-LunarVim/config.lua<CR>"),
    button("C", " " .. kind.cmp_kind.Color .. " Colorscheme Config", ":e ~/.config/nvim-LunarVim/lua/user/colorscheme.lua<CR>"),
